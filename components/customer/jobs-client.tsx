...
import { Search, MoreVertical, Users, MapPin, Clock, DollarSign, Eye, Pause, Trash2 } from "lucide-react"
...
export function CustomerJobsClient({ jobs }: { jobs: Job[] }) {
              ...
              <div className="flex items-start gap-4">
                ...
                <div className="flex flex-col items-end gap-2">
                  ...
                  <Button size="sm" asChild>
                    <Link href={`/customer/candidates?job=${job.id}`}>View Applicants</Link>
                  </Button>
                </div>
              </div>
            </CardContent>
