...
export function FreelancerJobsClient({ jobs }: { jobs: Job[] }) {
  ...
  return (
    <>
      ...
      <p className="text-sm text-muted-foreground">{filtered.length} jobs available</p>
                ...
                <div className="flex-1 min-w-0">
                  ...
                  <div className="flex flex-wrap gap-1.5">
                    {job.skills.map((skill) => (
                      <span key={skill} className="px-2.5 py-1 text-xs bg-muted rounded-md text-muted-foreground">
                        {skill}
                      </span>
                    ))}
                  </div>
